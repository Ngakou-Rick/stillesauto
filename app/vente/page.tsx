    ...
    <main className="min-h-screen bg-gray-50">
      <section className="bg-gray-900 text-white py-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-4xl font-bold mb-4">Vente de Véhicules</h1>
          <p className="text-gray-300 text-lg mb-8">
            Des véhicules de qualité à des prix compétitifs au Cameroun
          </p>
      ...
      <section className="max-w-6xl mx-auto px-4 py-12">
        <p className="text-gray-600 mb-8">
          <span className="font-bold text-gray-900">{total}</span> véhicule(s) en vente
        </p>
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {vehicles.map((vehicle) => (
              <VehicleCard key={vehicle.id} vehicle={vehicle} mode="sale" />
            ))}
          </div>
        )}
      </section>
